...
const treasure = document.getElementById('treasures');
...
treasures[1] = "sleutel";
treasures[2] = "corona";
treasures[3] = "schatkist";

treasuresImages = [];
treasures[1] = "Sleutel.png";
treasures[2] = "Corona.png";
treasures[3] = "Schatkist.png";
...
function showTreasure(currentLocation){
    if(typeof treasures[currentLocation] != "undefined"){
     ...
     treasure.scr = "treasures/" + treasuresImages[currentLocation];
	}
}
